  ...
  return (
    <div className='card col-span-1  p-4 rounded-lg '>
      <div className="relative">
          <img src="https://i.scdn.co/image/ab67706f0000000225d50fa7cc51b307364050f5" alt="" />
        ...
        <p className='text-xs text-gray-400 leading-4'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo</p>
    </div>
  )
}
export default Card
